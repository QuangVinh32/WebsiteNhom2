...
export const ShoppingContextProvider = ({ children }: ShoppingContextProviderProps) => {
    ...
    const addCartItem = (product: ProductItem) => {
        ...
        if (product) {
            const currentCartItem = cartItems.find(item => item.productId === product.productId)
            if (currentCartItem) {
                const newItems = cartItems.map(item => {
    ...
    const removeCartItem = (productId: number) => {
        ...
        const currentCartItemIndex = cartItems.findIndex(item => item.productId === productId)
